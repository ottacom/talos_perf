...
Generated: **2026-04-21T17:52:18Z**
...
| **Peak intra-node busbw (NVLink)** | **476.98 GB/s** |
| **Peak inter-node busbw (IB)** | **438.69 GB/s** |
...
|---|---:|---|
| Intra-node (NVLink/NVSwitch) | 476.98 GB/s | ✓ HEALTHY — NVLink near theoretical max |
| Inter-node (InfiniBand) | 438.69 GB/s | ✓ EXCELLENT — GDRDMA full throughput, ACS disabled |
...
|---:|---:|---:|---:|
| 1.00 MiB | 0.07 | 15.66 | **27.41** |
| 2.00 MiB | 0.04 | 51.12 | **89.46** |
| 4.00 MiB | 0.05 | 77.81 | **136.16** |
| 8.00 MiB | 0.08 | 107.81 | **188.66** |
| 16.00 MiB | 0.12 | 138.75 | **242.81** |
| 32.00 MiB | 0.20 | 167.62 | **293.33** |
| 64.00 MiB | 0.33 | 205.29 | **359.25** |
| 128.00 MiB | 0.59 | 226.79 | **396.89** |
| 256.00 MiB | 1.12 | 239.47 | **419.08** |
| 512.00 MiB | 2.17 | 247.46 | **433.06** |
| 1.00 GiB | 4.07 | 264.01 | **462.01** |
| 2.00 GiB | 8.01 | 267.99 | **468.99** |
| 4.00 GiB | 15.85 | 270.99 | **474.23** |
| 8.00 GiB | 31.52 | 272.56 | **476.98** |

## Inter-node all-reduce (16 GPUs)

| Message | Avg ms | algbw GB/s | busbw GB/s |
|---:|---:|---:|---:|
| 1.00 MiB | 0.22 | 4.69 | **8.79** |
| 2.00 MiB | 0.14 | 14.60 | **27.37** |
| 4.00 MiB | 0.20 | 20.50 | **38.44** |
| 8.00 MiB | 0.24 | 35.19 | **65.98** |
| 16.00 MiB | 0.31 | 54.69 | **102.54** |
| 32.00 MiB | 0.43 | 78.44 | **147.07** |
| 64.00 MiB | 0.53 | 127.55 | **239.16** |
| 128.00 MiB | 0.89 | 151.12 | **283.36** |
| 256.00 MiB | 1.49 | 179.64 | **336.83** |
| 512.00 MiB | 2.69 | 199.37 | **373.81** |
| 1.00 GiB | 5.09 | 210.84 | **395.32** |
| 2.00 GiB | 9.68 | 221.95 | **416.15** |
| 4.00 GiB | 18.65 | 230.34 | **431.89** |
| 8.00 GiB | 36.71 | 233.97 | **438.69** |
...
dgx052    Ready    <none>          3h32m   v1.35.2   10.10.5.50    <none>        Talos (v1.12.6)   6.18.18-talos    containerd://2.1.6
dgx053    Ready    <none>          3h32m   v1.35.2   10.10.5.51    <none>        Talos (v1.12.6)   6.18.18-talos    containerd://2.1.6
k8s-m01   Ready    control-plane   6h15m   v1.35.2   10.10.5.11    <none>        Talos (v1.12.6)   6.18.18-talos    containerd://2.1.6
k8s-m02   Ready    control-plane   6h16m   v1.35.2   10.10.5.12    <none>        Talos (v1.12.6)   6.18.18-talos    containerd://2.1.6
k8s-m03   Ready    control-plane   6h16m   v1.35.2   10.10.5.13    <none>        Talos (v1.12.6)   6.18.18-talos    containerd://2.1.6
